...
public class SelectableRoundedImageView extends AppCompatImageView {
    ...
    public static final String T1 = "RoundedImageView";
    ...
    public SelectableRoundedImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.SelectableRoundedImageView, defStyleAttr, 0);
    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                Log.w(T1, "Unable to find resource: " + mResource, e);
                // Don't try again.
                mResource = 0;
            }
        }
    ...
    static class SelectableRoundedCornerDrawable extends Drawable {
        ...
        private static final String T_2 = "SelectableRoundedCornerDrawable";
        private static final int DEFAULT_BORDER_COLOR = Color.BLACK;
        ...
        public static Drawable fromDrawable(Drawable drawable, Resources r) {
            if (drawable != null) {
                ...
                if (bm != null) {
                    ...
                    Log.w(T1, "Failed to create bitmap from drawable!");
                }
            }
            return drawable;
        }
